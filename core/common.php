...
trait Hmt_Common {
    ...
    protected function hmt_admin_sidebar() {
		?>
		<div class="hmt-admin-sidebar" style="width: 20%; float: left; margin-top: 5px;">
			<div class="postbox">
	...
	protected function hmt_build_set_settings_options( $fields, $post ) {
	...
	protected function hmt_build_get_settings_options( $fields, $settings ) {
